...
///Variabler som vi kommer behöva, Jag har lagt dom här för att kunna "Tweeka" i Prossesing3.////////////////////////////////////////////////////////////////
	...
	int svart = color(0,0,0,255); //<--Color är en inbyggt class som vi skapar våra färgvaribler med.	//color(Red, Green, Blue, Alpha).
	int gra = color(64,64,64,255);
	int lattVit = color(255,255,255,34);
	
	int numberOfLines = 20; //<-- Hur många linjer vår parabol ska ha.								// En Integer "int" kan inte ha decimaler
	float lineStep = 25.0f; 	//<-- Hur långt avstånd (i pixlar) det ska vara mellan kordinater.		// En floating-point "float" ett nummer kan ha decimaler 
